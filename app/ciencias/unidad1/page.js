...
export default function Unidad1() {
    ...
    <main className="min-h-screen p-10 text-white 
      ...
      <div className="max-w-xl mx-auto bg-white/10 p-8 rounded-2xl shadow-lg backdrop-blur-md">
        ...
        <ul className="space-y-3 text-blue-300 underline text-center">
          <li>
            <Link href="/pdf/ciencias-unidad1-tema1.pdf" target="_blank">
              📄 Guía 1
            </Link>
          </li>

          <li>
            <Link href="/pdf/ciencias-unidad1-tema2.pdf" target="_blank">
              📄 Guía 2
            </Link>
          </li>

          <li>
            <Link href="/pdf/ciencias-unidad1-tema3.pdf" target="_blank">
              📄 Guía 3
            </Link>
          </li>

          <li>
            <Link href="/pdf/ciencias-unidad1-tema4.pdf" target="_blank">
              📄 Guía 4
            </Link>
          </li>

          <li>
            <Link href="/pdf/ciencias-unidad1-tema5.pdf" target="_blank">
              📄 Guía 5
            </Link>
          </li>
          ...
          <li>
            <Link 
              href="/pdf/ciencias-unidad1-tema6 y evaluando lo aprendido.pdf" 
              target="_blank"
            >
              📄 Guía 6
            </Link>
  ...
  <iframe 
    width="560" 
    height="315" 
    src="https://www.youtube.com/embed/przV9YavZmI"
